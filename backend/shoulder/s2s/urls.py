...
router.register(r"onboarding", views.OnboardingViewSet)
...
router.register(r"suggestionresults", views.SuggestionResultsViewSet, basename="suggestion_results")
...
router.register(r"submit_onboarding", views.SubmitOnboardingViewSet, basename="submit_onboarding")
urlpatterns = [
